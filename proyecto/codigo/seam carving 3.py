...
def seam_carve(img_file, mode, mask = None): #accepts both files and arrays
    ...
    pic = imageio.imread("/OneDrive - Universidad EAFIT/2 SEM/Datos/proyecto/datasets/archivosCSV/ganado enfermo CSVs/R.jpg") if type("/OneDrive - Universidad EAFIT/2 SEM/Datos/proyecto/datasets/archivosCSV/ganado enfermo CSVs/R.jpg") == str else np.copy("/OneDrive - Universidad EAFIT/2 SEM/Datos/proyecto/datasets/archivosCSV/ganado enfermo CSVs/R.jpg")
    if mask is not None:
...
seam_carve("/OneDrive - Universidad EAFIT/2 SEM/Datos/proyecto/datasets/archivosCSV/ganado enfermo CSVs/R.jpg", "vertical")
